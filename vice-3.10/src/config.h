...
#define CONFIGURE_FLAGS "--enable-static --disable-shared --without-pulse --without-alsa --without-oss --without-sdlsound --without-gtk3 --without-gtk2 --without-headless --enable-external-ffmpeg --disable-catweasel --disable-hardsid --disable-parsid --disable-ethernet --disable-ipv6 --disable-cpuhistory --disable-debug"
