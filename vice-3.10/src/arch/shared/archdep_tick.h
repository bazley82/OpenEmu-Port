...
/* Using a 64-bit type for tick_t prevents wraparound bugs */
typedef uint64_t tick_t;

#define TICK_TO_MILLI(tick) ((uint64_t) (uint64_t)((double)(tick) * ((double)MILLI_PER_SECOND / TICK_PER_SECOND)))
#define TICK_TO_MICRO(tick) ((uint64_t) (uint64_t)((double)(tick) * ((double)MICRO_PER_SECOND / TICK_PER_SECOND)))
